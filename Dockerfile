...
# ================================
FROM --platform=$TARGETOS/$TARGETARCH http://base-php/base-php:$TARGETARCH AS composer
...
# ================================
FROM --platform=$TARGETOS/$TARGETARCH http://base-php/base-php:$TARGETARCH AS final
